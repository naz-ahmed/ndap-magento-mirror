<?php
    class AccurateTax_Advanced_Block_Adminhtml_Tax_Rate_Edit_Form extends Mage_Adminhtml_Block_Tax_Rate_Form {
        ...
        protected function _prepareForm() {
            ...
            $fieldset->addField('checkAT',  'select', array(
                'name' => 'checkAT',
                'label' => Mage::helper('tax')->__('Get from AccurateTax'),
                'options' => array(
                    '1' => Mage::helper('tax')->__('Yes'),
                    '0' => Mage::helper('tax')->__('No')
                )
