...
class Ess_M2ePro_Model_Synchronization_Tasks_Templates extends Ess_M2ePro_Model_Synchronization_Tasks
{
    ...
    private function getTemplatesWithListings()
    {
        ...
        //--------------------------
        $synchronizationObjects = Mage::getModel('M2ePro/SynchronizationsTemplates')
        ...
        foreach ($synchronizationObjects as $synchronizationObject) {
            ...
            /** @var $synchronizationObject Ess_M2ePro_Model_SynchronizationsTemplates */
            ...
            // Get listings
            //--------------------------
            $listingObjects = Mage::getModel('M2ePro/Listings')
                                    ->getCollection()
                                    ->addFieldToFilter('synchronization_template_id', $synchronizationObject->getId())
                                    ->getItems();
            ...
            foreach ($listingObjects as $listingObject) {
                ...
                /** @var $listingObject Ess_M2ePro_Model_Listings */
