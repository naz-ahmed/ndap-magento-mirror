    ...
    protected function _getCustomOptionsForOrder()
    {
        ...
        foreach ($productOptions as $option) {
            ...
            $customOption = array(
                ...
                'store_title'   => trim(strtolower($option->getData('store_title'))),
                'title'         => trim(strtolower($option->getData('title'))),
                'default_title' => trim(strtolower($option->getData('default_title'))),
                'values'        => array()
            );
            ...
            foreach ($values as $value) {
                $customOption['values'][] = array(
                    ...
                    'store_title'   => trim(strtolower($value->getData('store_title'))),
                    'title'         => trim(strtolower($value->getData('title'))),
                    'default_title' => trim(strtolower($value->getData('default_title')))
        ...
        foreach ($optionsCollection as $option) {
            ...
            foreach ($selectionsCollection as $selection) {
                ...
                $bundleOption['values'][] = array(
                    ...
                    'name'       => trim(strtolower($selection->getData('name'))),
    ...
    protected function _getConfigurableOptionsForOrder()
    {
        ...
        foreach ($productAttributes as $attribute) {
            ...
            $configurableOption = array(
                ...
                'store_label'    => trim(strtolower($attribute['store_label'])),
                'frontend_label' => trim(strtolower($attribute['frontend_label'])),
                'label'          => trim(strtolower($attribute['label'])),
                'values'         => array()
            );
            ...
            foreach ($attribute['values'] as $value) {
                $configurableOption['values'][] = array(
                    ...
                    'store_label'   => trim(strtolower($value['store_label'])),
                    'default_label' => trim(strtolower($value['default_label'])),
                    'label'         => trim(strtolower($value['label']))
                );
            }
