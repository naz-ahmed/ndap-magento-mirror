...
class Ess_M2ePro_Model_SellingFormatTemplates extends Mage_Core_Model_Abstract
{
    ...
    public function deleteInstance()
    {
        ...
        $attributeSets->addFieldToFilter('template_type', Ess_M2ePro_Model_TemplatesAttributeSets::TEMPLATE_TYPE_SELLING_FORMAT)
                      ->addFieldToFilter('template_id',(int)$this->getId());
