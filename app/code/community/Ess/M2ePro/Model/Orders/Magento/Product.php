...
class Ess_M2ePro_Model_Orders_Magento_Product extends Mage_Core_Model_Abstract
{
    ...
    public function createProduct()
    {
        ...
        var_dump($newProductGalleryImages);
    ...
    private function makeProductGallery($imagesList)
    {
        ...
        $media_gallery['values']['main'] = $mainImageToGallery;
        $media_gallery['values']['image'] = $mainImageToGallery;
        $media_gallery['values']['small_image'] = $mainImageToGallery;
        $media_gallery['values']['thumbnail'] = $mainImageToGallery;
