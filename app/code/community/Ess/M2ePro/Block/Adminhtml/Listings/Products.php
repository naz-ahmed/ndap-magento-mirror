...
class Ess_M2ePro_Block_Adminhtml_Listings_Products extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    public function __construct()
    {
        ...
        $this->_addButton('save_and_list', array(
            ...
            'onclick'   => 'ProductsGridHandlersObj.save_and_list_click(\''.$this->getUrl('*/*/products',array('id' => $listingData['id'],'back' => Mage::helper('M2ePro')->getBackUrlParam('*/adminhtml_listings/index'))).'\')',
            'class'     => 'save'
        ));
