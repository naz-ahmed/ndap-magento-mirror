...
CREATE TABLE m2epro_accounts (
  ...
  orders_status_payment_complete_mode TINYINT(2) UNSIGNED NOT NULL DEFAULT 0,
  orders_combined_mode TINYINT(2) UNSIGNED NOT NULL DEFAULT 1,
  ...
  INDEX mode (mode),
  INDEX orders_combined_mode (orders_combined_mode),
  INDEX orders_status_payment_complete_mode (orders_status_payment_complete_mode),
...
CREATE TABLE m2epro_ebay_orders (
  ...
  selling_manager_record_number INT(11) UNSIGNED DEFAULT 0,
  checkout_status TINYINT(2) UNSIGNED NOT NULL DEFAULT 0 COMMENT '0 - Incomplete, 1 - Completed',
  checkout_message VARCHAR(500) DEFAULT NULL,
  update_time DATETIME DEFAULT NULL,
  payment_time DATETIME DEFAULT NULL,
  payment_used VARCHAR(255) DEFAULT NULL,
  payment_status VARCHAR(255) DEFAULT NULL,
  payment_hold_status VARCHAR(255) DEFAULT NULL,
  payment_status_m2e_code TINYINT(2) UNSIGNED NOT NULL DEFAULT 0 COMMENT '0 - Not Selected, look into helper code Sales.php ',
...
INSERT INTO ess_config (`group`, `key`, `value`, `notice`, `update_date`, `create_date`) VALUES
  ...
  ('/server/', 'baseurl', 'https://m2epro.com/', 'Support server base url', '2011-03-01 10:15:03', '2011-03-01 10:15:03'),

  ('/modules/', 'M2ePro', '0.0.0.r0', '"Magento To Ebay" module', '2011-08-17 10:39:24', '2011-01-19 15:43:36'),

  ('/M2ePro/', 'application_key', 'b79a495170da3b081c9ebae6c255c7fbe1b139b5', 'Application key', '2011-02-24 09:52:27', '2011-02-24 09:52:27'),
  ...
  ('/M2ePro/server/', 'directory', '/server/', 'Server scripts directory', '2011-03-03 13:57:49', '2011-03-03 13:57:49'),
  ...
  ('/M2ePro/license/', 'status', '0', '0 - None\r\n1 - Active\r\n2 - Suspended\r\n3 - Closed', '2011-07-28 09:01:01', '2011-01-19 15:43:36'),
...
INSERT INTO m2epro_config (`group`, `key`, `value`, `notice`, `update_date`, `create_date`) VALUES
  ...
  ('/logs/cleaning/listings/', 'mode', '1', '0 - disable, \r\n1 - enable', '2011-06-07 11:06:36', '2010-12-16 09:58:38'),
  ...
  ('/logs/cleaning/ebay_listings/', 'mode', '1', '0 - disable, \r\n1 - enable', '2011-04-01 11:00:32', '2010-12-16 09:57:25'),
  ...
  ('/logs/cleaning/synchronizations/', 'mode', '1', '0 - disable, \r\n1 - enable', '2011-06-07 11:06:36', '2010-12-23 09:46:58'),
  ...
  ('/synchronization/lockItem/', 'max_deactivate_time', '600', 'in seconds', '2010-12-16 10:20:43', '2011-01-14 15:23:06'),
  ('/synchronization/profiler/', 'mode', '1', '1 - production, \r\n2 - debugging, \r\n3 - developing', '2011-02-18 10:01:54', '2011-01-14 16:20:14'),
  ('/synchronization/profiler/', 'print_type', '2', '1 - var_dump() ,\r\n2 - print + <br/>,\r\n3 - print + EOL', '2010-12-16 10:20:43', '2011-01-18 14:52:03'),
  ('/synchronization/profiler/', 'delete_resources', '0', '0 - disable, \r\n1 - enable', '2011-02-18 10:01:54', '2011-01-17 17:10:01'),
  ('/synchronization/memory/', 'mode', '1', '0 - disable, \r\n1 - enable', '2010-12-16 10:20:43', '2011-01-18 12:04:24'),
  ('/synchronization/memory/', 'max_size', '512', 'in Mb', '2010-12-16 10:20:43', '2011-01-18 12:03:07'),

  ('/synchronization/settings/defaults/', 'mode', '1', '0 - disable, \r\n1 - enable', '2011-01-12 02:55:16', '2011-01-12 02:55:16'),
  ('/synchronization/settings/defaults/update_listings_products/', 'mode', '1', '0 - disable, \r\n1 - enable', '2011-01-12 02:55:16', '2011-01-10 10:36:58'),
  ('/synchronization/settings/defaults/update_listings_products/', 'since_time', NULL, 'eBay time of last check changes on eBay', '2011-08-04 14:50:34', '2010-12-16 10:20:43'),
  ('/synchronization/settings/defaults/remove_deleted_products/', 'mode', '1', '0 - disable, \r\n1 - enable', '2011-01-17 02:11:56', '2011-01-14 15:05:01'),
  ('/synchronization/settings/orders/', 'mode', '1', '0 - disable, \r\n1 - enable', '2011-05-12 09:04:57', '2010-12-16 09:14:39'),
  ('/synchronization/settings/orders/', 'since_time', NULL, 'eBay time of last check changes on eBay', '2011-05-11 09:10:33', '2011-04-27 09:37:01'),
  ('/synchronization/settings/templates/', 'mode', '1', '0 - disable, \r\n1 - enable', '2011-06-14 13:40:41', '2011-01-18 16:28:55'),
  ...
  ('/synchronization/settings/templates/inspector/', 'last_time', NULL, 'Last check time', '2011-05-11 09:10:33', '2011-04-27 09:37:01'),
  ...
  ('/synchronization/settings/feedbacks/', 'mode', '1', '0 - disable, \r\n1 - enable', '2011-05-12 09:24:31', '2010-12-16 09:27:15'),
  ('/synchronization/settings/feedbacks/receive/', 'mode', '1', '0 - disable, \r\n1 - enable', '2011-01-10 01:44:02', '2011-01-10 01:44:02'),
  ('/synchronization/settings/feedbacks/response/', 'mode', '1', '0 - disable, \r\n1 - enable', '2011-01-10 01:44:02', '2011-01-10 01:44:02'),
  ('/synchronization/settings/messages/', 'mode', '0', '0 - disable, \r\n1 - enable', '2011-08-10 09:24:28', '2011-08-10 09:19:42'),
  ('/synchronization/settings/messages/receive/', 'mode', '0', '0 - disable, \r\n1 - enable', '2011-01-10 01:44:02', '2011-01-10 01:44:02'),
  ('/synchronization/settings/marketplaces/', 'mode', '1', '0 - disable, \r\n1 - enable', '2011-01-12 02:55:16', '2011-01-12 02:55:16'),
  ('/synchronization/settings/marketplaces/default/', 'mode', '1', '0 - disable, \r\n1 - enable', '2010-12-16 10:20:43', '2011-01-18 16:27:23'),
  ('/synchronization/settings/marketplaces/default/', 'last_time', NULL, 'Last check time', '2011-06-29 14:33:35', '2010-12-16 10:20:43'),
  ('/synchronization/settings/marketplaces/details/', 'mode', '1', '0 - disable, \r\n1 - enable', '2010-12-16 10:20:43', '2011-01-18 16:28:01'),
  ('/synchronization/settings/marketplaces/categories/', 'mode', '1', '0 - disable, \r\n1 - enable', '2011-01-12 02:55:16', '2011-01-12 02:55:16'),
  ('/synchronization/settings/ebay_listings/', 'mode', '1', '0 - disable,\n1 - enable', '2011-06-07 10:05:39', '2011-01-12 02:55:16'),

  ('/listings/lockItem/', 'max_deactivate_time', '600', 'in seconds', '2010-12-16 10:20:43', '2011-01-19 15:43:36'),
  ('/products/settings/', 'show_thumbnails', '1', 'Visibility thumbnails into grid', '2011-07-08 09:58:37', '2010-12-23 02:54:16'),
  ('/block_notices/settings/', 'show', '1', '0 - disable, \r\n1 - enable', '2011-07-18 15:57:34', '2010-12-23 02:54:16'),
  ('/debug/exceptions/', 'send_to_server', '1', '0 - disable,\r\n1 - enable', '2011-07-18 15:57:34', '2011-07-18 15:57:34'),
  ('/debug/fatal_error/', 'send_to_server', '1', '0 - disable,\r\n1 - enable', '2011-07-18 15:57:34', '2011-07-18 15:57:34'),
  ('/feedbacks/notification/', 'mode', '1', '0 - disable, \r\n1 - enable', '2011-07-26 14:05:06', '2011-07-26 13:26:47'),
  ('/feedbacks/notification/', 'last_check', NULL, 'Date last check new buyers feedbacks', '2011-08-17 12:11:19', '2011-07-26 12:55:44'),
  ...
  ('/messages/notification/', 'mode', '0', '0 - disable,\r\n1 - enable', '2011-08-08 12:06:42', '2011-08-11 12:06:40'),
  ('/messages/notification/', 'last_check', NULL, 'Time of last check for new eBay messages', '2011-08-17 12:11:19', '2011-08-11 12:12:17'),
  ...
  ('/cron/notification/', 'inactive_hours', '12', 'Allowed number of hours cron could be inactive', '2011-08-17 12:11:19', '2011-08-11 12:12:17'),
  ('/templates/description/', 'convert_linebreaks', '1', '0 - No\r\n1 - Yes', '2011-08-17 12:11:19', '2011-08-11 12:12:17'),
  ('/documentation/', 'baseurl', 'http://docs.m2epro.com/display/M2EPro/M2E+Pro/', 'Documentation baseurl', '2011-04-20 15:20:53', '2011-04-20 15:20:53'),
  ('/support/', 'defect_mail', 'support@m2epro.com', 'Defect email address', '2011-03-03 13:57:49', '2011-03-03 13:57:49'),
  ('/support/', 'feature_mail', 'support@m2epro.com', 'Feature email address', '2011-03-03 13:57:49', '2011-03-03 13:57:49'),
  ('/support/', 'inquiry_mail', 'support@m2epro.com', 'Inquiry email address', '2011-03-03 13:57:49', '2011-03-03 13:57:49'),
  ('/support/uservoice/', 'mode', '1', '0 - disable,\r\n1 - enable', '2011-02-24 09:52:27', '2011-02-24 09:52:27'),
  ('/support/uservoice/', 'baseurl', 'http://magento2ebay.uservoice.com/api/v1/', 'UserVoice api baseurl', '2011-02-24 09:52:27', '2011-02-24 09:52:27'),
  ('/support/uservoice/', 'client_key', 'WEsfO8nFh3FXffUU1Oa7A', 'UserVoice api client key', '2011-02-24 09:52:27', '2011-02-24 09:52:27');

TRUNCATE TABLE m2epro_marketplaces;
INSERT INTO m2epro_marketplaces VALUES
  ...
  (15, 'Australia', 'Australia', 'ebay.com.au', 0, 17, 0, 'Asia / Pacific', '2011-06-29 14:33:34', '2011-05-05 06:55:43'),
  (16, 'Austria', 'Austria', 'ebay.at', 0, 4, 0, 'Europe', '2011-06-29 14:33:34', '2011-05-05 06:55:43'),
  (23, 'Belgium (French)', 'Belgium_French', 'befr.ebay.be', 0, 6, 0, 'Europe', '2011-06-29 14:33:34', '2011-05-05 06:55:43'),
  ...
  (100, 'eBay Motors', 'eBayMotors', 'motors.ebay.com', 0, 23, 0, 'Other', '2011-06-29 14:33:34', '2011-05-05 06:55:43'),
  (101, 'Italy', 'Italy', 'ebay.it', 0, 10, 0, 'Europe', '2011-06-29 14:33:34', '2011-05-05 06:55:43'),
  (123, 'Belgium (Dutch)', 'Belgium_Dutch', 'benl.ebay.be', 0, 5, 0, 'Europe', '2011-06-29 14:33:34', '2011-05-05 06:55:43'),
  ...
  (201, 'Hong Kong', 'HongKong', 'ebay.com.hk', 0, 18, 0, 'Asia / Pacific', '2011-06-29 14:33:35', '2011-05-05 06:55:43'),
  ...
  (207, 'Malaysia', 'Malaysia', 'ebay.com.my', 0, 20, 0, 'Asia / Pacific', '2011-06-29 14:33:35', '2011-05-05 06:55:44'),
  (210, 'Canada (French)', 'CanadaFrench', 'cafr.ebay.ca', 0, 2, 0, 'America', '2011-06-29 14:33:35', '2011-05-05 06:55:44'),
  (211, 'Philippines', 'Philippines', 'ebay.ph', 0, 21, 0, 'Asia / Pacific', '2011-06-29 14:33:35', '2011-05-05 06:55:44'),
  (212, 'Poland', 'Poland', 'ebay.pl', 0, 12, 0, 'Europe', '2011-06-29 14:33:35', '2011-05-05 06:55:44'),
  (216, 'Singapore', 'Singapore', 'ebay.com.sg', 0, 22, 0, 'Asia / Pacific', '2011-06-29 14:33:35', '2011-05-05 06:55:44'),
