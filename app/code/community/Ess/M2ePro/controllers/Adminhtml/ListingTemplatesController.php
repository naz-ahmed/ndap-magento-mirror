...
class Ess_M2ePro_Adminhtml_ListingTemplatesController extends Ess_M2ePro_Controller_Adminhtml_MainController
{
    ...
    public function editAction()
    {
        ...
        // Load payments
        //-------------------------
        $payments = Mage::getModel('M2ePro/ListingsTemplatesPayments')->getCollection()
    ...
    public function saveAction()
    {
        ...
        $data['local_shipping_cash_on_delivery_cost_mode'] = isset($post['local_shipping_cash_on_delivery_cost_mode']) ? $post['local_shipping_cash_on_delivery_cost_mode'] : Ess_M2ePro_Model_ListingsTemplates::CASH_ON_DELIVERY_COST_MODE_NONE;
        $data['local_shipping_cash_on_delivery_cost_value'] = isset($post['local_shipping_cash_on_delivery_cost_value']) ? str_replace(',', '.', $post['local_shipping_cash_on_delivery_cost_value']) : 0;
        $data['local_shipping_cash_on_delivery_cost_attribute'] = isset($post['local_shipping_cash_on_delivery_cost_attribute']) ? $post['local_shipping_cash_on_delivery_cost_attribute'] : '';
