    					...
    					if($col->type == 'attribute'){
    						...
    						switch($col->attribute_value):
    							...
    							case('qty'):
    								...
    								$value = ceil(Mage::getModel('cataloginventory/stock_item')->loadByProduct($product)->getQty());
	    										...
	    										foreach($option['condition'] as $condition){
	    											...
	    											switch($condition['attribute_code']):    							    							
                            							...
                            							case('qty'):
	    													...
	    													$attr_value = ceil(Mage::getModel('cataloginventory/stock_item')->loadByProduct($product)->getQty());
...
//                            								}
                                                        ...
                                                        case('is_in_stock'):
	    													...
	    													$attr_value = ceil(Mage::getModel('cataloginventory/stock_item')->loadByProduct($product)->getIsInStock());
...
//                								            if($stock_item = $stock_collection->getItemByColumnValue('product_id', $product->getId())){
//
//                            									$attr_value = str_replace("  "," ",$stock_collection->getItemByColumnValue('product_id', $product->getId())->getData('is_in_stock'));
//
//                            								}else{
//
//                            									$attr_value = 0;
