LicenseHandlers = Class.create();
LicenseHandlers.prototype = Object.extend(new CommonHandlers(), {
        ...
        new Ajax.Request( M2ePro.url.checkLicense ,
        {
            ...
            onSuccess: function(transport)
            {
                ...
                if (checkResult) {
                    ...
                    MagentoMessagesObj.addError(M2ePro.text.license_validation_error);
                }
            }
        });
    }
