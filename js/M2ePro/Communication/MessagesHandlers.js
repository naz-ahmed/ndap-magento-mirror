MessagesHandlers = Class.create();
MessagesHandlers.prototype = Object.extend(new CommonHandlers(), {
    ...
    {
        var messageInfo = MessagesHandlersObj.getMessageInfo(messageId);
        MessagesHandlersObj.openMessageWindow(messageInfo['text'], M2ePro.text.message_text_title);
    },
    ...
    {
        var messageInfo = MessagesHandlersObj.getMessageInfo(messageId);
        MessagesHandlersObj.openMessageWindow(messageInfo['responses'][response], M2ePro.text.message_response_title);
    },
    ...
    openMessage: function(self,messageId,messageSubject)
    {
        ...
        $('magento_block_messages_response').show();
    ...
    {
        $('magento_block_messages_response').hide();
    },
    ...
    sendMessage: function()
    {
        ...
        if (editForm.validate()) {
            ...
            new Ajax.Request( M2ePro.url.formSubmit + '?' + $('edit_form').serialize(),
            {
                ...
                onSuccess: function(transport)
                {
                    MagentoMessagesObj.addSuccess(M2ePro.text.message_sent_successfully);
